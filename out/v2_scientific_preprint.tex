...
This global pass rate is substantially lower than the 15--17\% experimental hit rate reported for RFAntibody's benchmark targets \cite{watson2025}, reflecting both the stringency of our computational filters and the intrinsic difficulty of the cancer targets selected for this study.
...
CEACAM5 is the target of the ADC tusamitamab ravtansine, which achieved a 20\% objective response rate in PDAC (ASCO 2025), validating this epitope as therapeutically productive \cite{ceacam5structure2024}.
...
Paradoxically, EGFRvIII has the highest-resolution template in this study (PDB: 8UKV at 1.8\,\AA).
...
In contrast, the near-complete failure of EGFRvIII design (0.3\%) despite having the highest-resolution template (1.8\,\AA) highlights that template quality alone does not predict design success.
